...
public class StorageService {
    ...
    public List<StorageItemResponse> getFolderContents(String folderId) {
        ...
        // Obtener todos los elementos dentro de la carpeta (no eliminados)
        List<FileMetadata> contents = fileMetadataRepository.findByParentFolder(parentFolder)
                .stream()
...
// ==============================================================
    ...
    private StorageItemResponse mapToStorageResponse(FileMetadata item, User currentUser) {
        ...
        // Obtener estado de desbloqueo si es un archivo personal
        if (!item.getIsFolder()) {
        ...
        return StorageItemResponse.builder()
                ...
                .isLocked(!item.getIsFolder() && !isUnlocked &&
                        !(getPersonalFileShareSecurityLevel(item, currentUser) == SecurityLevel.PUBLIC))
